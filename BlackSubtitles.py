        ...
        while True:
            ...
            for i in self.text_array:
                if N_frames >= i[1] and N_frames <= i[2]:
                    ...
                    text_y = int(height/1.1)  # Adjust the vertical position

                    # Draw a semi-transparent background
                    cv2.rectangle(frame, (text_x - 5, text_y - text_size[1] - 5),
                                  (text_x + text_size[0] + 5, text_y + 5), (0, 0, 0), -1, cv2.LINE_AA)

                    cv2.putText(frame, text, (text_x, text_y), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (250, 250, 250), 2)
                    break
